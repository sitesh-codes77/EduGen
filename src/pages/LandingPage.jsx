    ...
    <div style={{ minHeight: '100vh', backgroundColor: 'var(--canvas)', display: 'flex', flexDirection: 'column' }}>
      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '8rem 1.5rem 4rem', position: 'relative', overflow: 'hidden' }}>
        ...
        <motion.div 
          ...
          style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', backgroundColor: 'var(--primary-dim)', border: '1px solid rgba(14,165,233,0.3)', borderRadius: '999px', padding: '5px 14px', marginBottom: '1.75rem', color: '#0EA5E9', fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.06em', textTransform: 'uppercase' }}>
        ...
        <motion.p 
          ...
          style={{ color: 'var(--text-2)', fontSize: 'clamp(1rem,2vw,1.15rem)', maxWidth: '540px', lineHeight: 1.7, marginBottom: '2.25rem' }}>
        ...
        <motion.div 
          ...
          style={{ display: 'flex', gap: '3rem', marginTop: '3.5rem', flexWrap: 'wrap', justifyContent: 'center' }}>
